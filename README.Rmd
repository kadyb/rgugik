...
Currently you can download:
  ...
  - Various Digital Elevation Models as:
    ...
    - [Digital Surface Model](www.gugik.gov.pl/pzgik/zamow-dane/numeryczny-model-pokrycia-terenu)
    - [Point Cloud](http://www.gugik.gov.pl/pzgik/zamow-dane/dane-pomiarowe)
  - *Digital Terrain Model as vector points with 1 m resolution and as text files with 100 m resolution for entire voivodeships
