...
```{r echo=FALSE}
ds_pl = c("Ortofotomapa", "Numeryczny Model Terenu", "Baza Danych Obiektów Ogólnogeograficznych", "Państwowy Rejestr Nazw Geograficznych", "Lokalizacja działek katastralnych", "Modele 3D budynków")
ds_en = c("Orthophotomap", "Digital Terrain Models", "General Geographic Database", "State Register of Geographical Names", "Location of cadastral parcels", "3D models of buildings")
fun = c("orto_request, orto_download", "pointDTM_get, pointDTM100_download", "geodb_download", "geonames_download", "parcel_get", "models3D_download")
input = c("polygon", "polygon, voivodeship (TERC)", "voivodeship (TERC)", "place, object", "parcel ID, coordinates", "county (TERYT)")
