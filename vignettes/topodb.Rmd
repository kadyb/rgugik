...
The thematic scope includes information on water network, communication network, land cover, buildings, technical structures, land use, protected areas, and territorial division units.
...
We focus on four cases, taking point, line, and polygon data and their attributes into account.
...
We also can exclude *PL.PZGiK.332.1801__OT_PTSO_A.xml* file from list, because this file contains zero features.
...
area_landcover = lapply(area_landcover, sum)
# convert from a list to a vector
area_landcover = as.numeric(area_landcover)
# convert units
...
```
## Units: [km^2]
##   fallowlands communication        forest 
##    0.07561383    1.97014481  860.17248134 
##   undeveloped       squares    shrublands 
##    0.27817715    0.29038385    1.57266555 
##         crops     grassland         water 
##  255.13528884    0.63447491    8.81181550 
##         heaps     buildings 
##    0.09220115   10.38781092
```
...
```
##        forest         crops     buildings 
##         75.49         22.39          0.91 
##         water communication    shrublands 
##          0.77          0.17          0.14 
##     grassland       squares   undeveloped 
##          0.06          0.03          0.02 
##   fallowlands         heaps 
##          0.01          0.01
```
