...
Możemy wyświetlić jego geometrię wykorzystując funkcję `plot()`.
...
Atrybut *seriesID* (niewidoczny w poniższej uproszczonej tabeli) służy więc do łączenia mniejszych obrazów w większe mozaiki.
